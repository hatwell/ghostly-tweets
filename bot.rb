...
potential_tweets = ["a #{spooky_things["spooky_adjective"][rand(4)]} #{spooky_things["spooky_thing"][rand(10)]} is #{spooky_things["spooky_verb"][rand(3)]} you. #{spooky_things["spooky_emoji"][rand(3)]}", "#{tweets[rand(0..tweets.length-1)]} #{emoji[rand(0..emoji.length-1)]}" ]




client.update(potential_tweets[rand(0..1)])
